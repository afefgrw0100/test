...
<html>
    ...
    <span class="time">上次登录时间：<i><?php echo empty(session('user.LastLoginTime'))?"当前是第一次登录":session('user.LastLoginTime');?></i></span>
					...
					<div class="todo floor mt70">
						<div class="title">我的经纪人</div>
						<div class="mypublish">
							<form action="<?php echo U('User/Common/partner');?>" method="get">
							<div class="fl project-title">
								 <span><em>姓名：</em><input class="form-control" type="text" name="name" /></span>
							 <span><em>手机：</em><input class="form-control" type="text" name="phone" /></span>
							</div>
							
							<div class="fl time"><input type="submit" value="查询" class="btn"></div>
							</form>
							</div>
						...
						<div class="table">
							...
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td><?php echo ($vo["pname"]); echo ($vo["cname"]); echo ($vo["Street"]); ?></td>
