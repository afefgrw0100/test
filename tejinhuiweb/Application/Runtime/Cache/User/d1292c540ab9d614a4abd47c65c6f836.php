			...
			<div class="pay">
				...
				<div class="list">
					...
					<div class="con">
						...
						<div class="num"><?php echo empty($info['Projectnum'])?1:$info['Projectnum'];?></div>
				...
				<div class="total_price2">
					<span>账户可用余额:<em>¥<?php echo yue();?></em></span>
				</div>
				<div class="total_price">
					应付金额:<em>¥<?php echo ($info["DealPrice"]); ?></em>
				</div>
				<div class="total_price2">
					<span>微信应支付金额:<em>¥<?php echo ($info['DealPrice']-yue()); ?></em></span>
				</div>
				<div class="tel">
					<div class="title">您的手机</div>
					<div class="con">支付成功后，特金汇将发送您本次的消费信息到手机号码：<em><?php echo ($_SESSION['user']['CellPhone']); ?></em></div>
				</div>
				<div class="pay_way">
					...
					<div class="con">
						...
						<div class="fr"><img src="//www.3qqq.com/static/images/common/phone-bg.png"></div>
					</div>
...
//    });
		...
		<script type="text/javascript">
			...
			//初始化消息列表数据
			getData("<?php echo authcode($info['id'],'ENCODE');?>");
			setInterval("getData(\"<?php echo authcode($info['id'],'ENCODE');?>\")",20000);
