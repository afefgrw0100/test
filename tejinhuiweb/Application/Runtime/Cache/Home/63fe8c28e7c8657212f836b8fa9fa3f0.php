			...
			<div class="pub_detail">
				...
				<div class="box1">
					...
					<div class="btn1 active">
						<span class="sale">
						<a href="<?php echo U('Home/lists/content',array('AssetsID'=>$asset['AssetsID'],'card'=>authcode(session('user.MemberId'),'ENCODE'),'typepay'=>'ccc'));?>" class="buy2" ><?php if($source == 1): ?>查看评估报告<?php else: ?>查看尽调报告<?php endif; ?></a>
							</span>
				...
				<div class="box2">
					...
					<div class="con">
						<?php if($asset['PayModes'] == 0): ?><ul>
								...
								<li><b><?php if($source == 6): ?>资产月租价格<?php else: ?>资产出售价格<?php endif; ?>：</b><em class="info_num numtenhousand"><?php echo ($asset["proprice"]); ?>  元</em></li>
