<?php if (!defined('THINK_PATH')) exit();?><link rel="stylesheet" href="<?php echo tempurl('/static/style/user.css');?>" />
<div class="fr">
    <div class="top_right">
        <span class="hello">Hi , <i><?php echo dataG(); echo ($user["RealName"]); ?></i></span>
        <span class="time">上次登录时间：<i><?php echo empty($user['LastLoginTime'])?"当前是第一次登录":$user['LastLoginTime'];?></i></span>
        <span class="btn"><a class="btn1">充值</a><a  class="btn2">提现</a></span></div>
    <div class="baseInfo floor">

        <div class="title"><b>基本信息</b><em><a href="<?php echo U('User/Economic/visitf');?>">修改</a></em> <span><a href="<?php echo U('User/Economic/economic');?>">成为经纪人</a></span></div>
        <div class="con">
            <ul>
        ...
        <div class="con">
            <ul>
                ...
                <li>
                    ...
                    <span class="info2"><b>¥<em class="info_num"><?php echo empty($user['FreezeAmount'])?"还没算法":$user['FreezeAmount'];?></em></b><i>元</i></span>
    ...
    <div class="accoutsafe floor">
        ...
        <div class="con">
            ...
            <table class="table" border="" cellspacing="" cellpadding="">
                <tbody>
                <tr><td>登录密码</td><td>用于可登录的密码</td><td><a href="">修改密码</a></td></tr>
                </tbody>
