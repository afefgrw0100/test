					...
					<form id="pub_Object" method="post" action="<?php echo U('Web/Assets/add_edit');?>" enctype="multipart/form-data">
						<ul>
							<li style="display: none">
								...
								<input type="hidden" name="source" value="1" id="sourceclick" />
								<label>司法拍卖</label>
							...
							<article id="tempAuc">
								...
								<li>
									<label class="label"><span class="need"></span>市场价值：</label>
									<input type="text" value="" name="price" class="form-control pricevalid">
								</li>

								<li>
									<label class="label"><span class="need"></span> 保留价格：</label>
									<input type="text" value="" name="ReservePrices" class="form-control ReservePricevalid">
								</li>
								<li>
									<label class="label"><span class="need"></span> 保证金：</label>
									<input type="text" value="" name="Bonds" class="form-control Bondvalid">
								</li>
								<li>
									<label class="label"><span class="need"></span>拍卖起始时间：</label>
									<input type="text" name="AuctionStarts" class="sang_Calender AuctionStartvalid" id="t1" onclick="laydate()"/>
								</li>

								<li>
									<label class="label"><span class="need"></span> 付款方式：</label>
									<input type="radio" name="PayModes" value="1" />
									<label>全款</label>
									<input type="radio" value="2" name="PayModes" />
									<label>按揭</label>
								</li>
								<li>
								...
								<li>
									<span class="fl_box"><label class="label"><span class="need"></span>起拍价格：</label>
											<span class="dp-spabb">
