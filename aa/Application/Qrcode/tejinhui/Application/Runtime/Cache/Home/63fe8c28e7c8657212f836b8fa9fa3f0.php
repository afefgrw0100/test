	...
	.main{ background: #f5f5f5; margin-top: 20px; overflow: hidden;}
		...
		<div class="main">
			<div class="pub_detail">
				<div class="box1">
					...
					<div class="line">
						<ul>
							...
							<li><i class="iconfont">&#xe604;</i><em><?php echo empty($asset['BuyCount'])?"0":$asset['BuyCount'];?></em>人付款</li>
						</ul>
					</div>
					<div class="btn1">
						<a href="<?php echo U('User/Logic/buymic',array('type'=>'assets',buyid =>$asset['AssetsID']));?>" class="buy">购买尽调报告</a>
				...
				<div class="box2">
					<div class="fl"><img src="/static/images/common/detail_07.jpg"></div>
					<div class="con">
						<ul>
							<li><b>资产评估：</b><em class="info_num"><?php echo ($assset["price"]); ?>  元</em></li>
							...
							<li><b>资产出售价格：</b><em class="info_num"><?php echo ($asset["proprice"]); ?>  元</em></li>
							<li><b>使用现状：</b><em><?php echo ($asset["Usestat"]); ?></em></li>
							<li><b>折      扣：</b><em>0.8</em></li>
							<li><b>资产状态：</b><em><?php echo ($asset["source"]); ?></em></li>
				...
				<div class="box2">
					...
					<div class="fr"><img src="/static/images/common/detail_11.jpg"></div>
				</div>
				<div class="box3">
					<div class="title"><img src="/static/images/common/detail_15.jpg"></div>
					<div class="con div_scroll">
						<?php echo ($asset["ReportDesc"]); ?>
					</div>
				</div>
				<div class="box4">
					<div class="title"><img src="/static/images/common/detail_18.jpg"></div>
					<div class="con">
						<?php if(is_array($asset["Images"])): $i = 0; $__LIST__ = $asset["Images"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$imgs): $mod = ($i % 2 );++$i;?><img src="<?php echo imgpublic($imgs);?>"><?php endforeach; endif; else: echo "" ;endif; ?>
					</div>
				</div>
				<div class="star">
