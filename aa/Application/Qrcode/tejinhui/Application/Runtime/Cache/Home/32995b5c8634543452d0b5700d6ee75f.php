...
<!-- header end -->
		<div class="main">
			<div class="tjh_news">
				<div class="ad"><img src="/static/images/common/new_02.jpg"></div>
				<div class="con">
					<h2><b>公司新闻</b><em>/news</em></h2>
					<ul>
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><em><a href="<?php echo U('index/artcon',array('artid'=>$vo['id']));?>"><?php echo ($vo["title"]); ?></a><b><?php echo ($vo["createtime"]); ?></b></em></li><?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
