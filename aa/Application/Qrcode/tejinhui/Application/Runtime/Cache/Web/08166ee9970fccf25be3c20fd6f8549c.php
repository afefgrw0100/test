	...
	.main{ background: #f5f5f5; margin-top: 20px; overflow: hidden;}
		...
		<div class="main">
			<div class="pub_detail">
				<div class="box1">
					<div class="name">实物免费查看页面</div>
					<div class="time">发布时间：2016年11月10日</div>
					<div class="line">
						<ul>
							<li><i class="iconfont">&#xe6ed;</i><em><?php echo empty($asset['ViewCount'])?"0":$asset['ViewCount'];?></em>人看过</li>
							<li class="share"><i class="iconfont">&#xe67e;</i><em><?php echo empty($debt['ShareCount'])?"0":$asset['ShareCount'];?></em>次分享</li>
							<li><i class="iconfont">&#xe604;</i><em><?php echo empty($asset['BuyCount'])?"0":$asset['BuyCount'];?></em>人付款</li>
						</ul>
					</div>
					<div class="btn1">
						<a href="" class="buy">购买尽调报告</a>
				...
				<div class="box4">
					...
					<div class="con">
						<img src="/static/images/temp/detail_21.jpg">
						<img src="/static/images/temp/detail_21.jpg">
						<img src="/static/images/temp/detail_21.jpg">
					</div>
				</div>
