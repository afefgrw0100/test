			...
			<div class="main">
				...
				<div class="pub_report">
					<ul>
						...
						<li>
							<b>查看尽调报告费用：</b>
							<em><input type="text" name="ViewPrice"  value="" class="form-control" name="ViewPrice" /></em>
							<i>元</i>
						</li>
						<li>
							<b>买断尽调报告费用：</b>
							<em><input type="text" name="BuyPrice"  value="" class="form-control" name="BuyPrice"  /></em>
							<i>元</i>
						</li>
						<div class="submit">
