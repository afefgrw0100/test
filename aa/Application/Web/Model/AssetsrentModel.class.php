...
namespace Web\Model;
use Think\Model;
class AssetsrentModel extends Model{
    protected $tableName = "assets_rent";
    protected $_map = array(
        // 'admin'=>'users_name',
        'title'=>'Title',//标题
        'Price'=>'price',//资产评估价
        'assetstype'=>'AssetsType',//资产类型
        'source'=>'Source',//资产来源
        ...
        'titimgs'=>'titimg',//样品图片
        'Deposit'=>'deposit',//押金
        'CentMode'=>'centMode',//租金支付方式
        'Acreage'=>'acreage',//面积

//        `deposit` double DEFAULT NULL COMMENT '押金',
//  `centMode` int(11) DEFAULT NULL COMMENT '租金支付方式',
//  `acreage` double(10,2) DEFAULT NULL COMMENT '面积',
    ...
    public function lists($map){
        ...
        $assetinfo = $asset_model->field("
                ...
                Source as source,
                acreage as Acreage
                ")->where($map)->order("AssetsID desc")->select();
